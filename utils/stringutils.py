...
def deindent_code(code):
    """
    Removes all indents and unnecessary whitespace from the given code string.
    
    Args:
        code (str): The input code as a string.
    
    Returns:
        str: The de-indented code with no leading/trailing or unnecessary whitespace.
    """
    ...
    # Join the stripped lines with a single space
    deindented_code = "\n".join(stripped_lines)
    
    return deindented_code
